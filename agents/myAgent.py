...
class Agent(object):
    def __init__(self, agent_number, params={}):
        ...
        self.filename1 = 'agents/myAgent_files/user_model'
        self.user_model = pickle.load(open(self.filename1, 'rb'))
        self.filename2 = 'agents/myAgent_files/demand_model'
        self.demand_model = pickle.load(open(self.filename2, 'rb'))
        self.item0file = 'agents/myAgent_files/item0embedding'
        self.item0_embedding = pickle.load(open(self.item0file, 'rb'))
        self.item1file = 'agents/myAgent_files/item1embedding'
